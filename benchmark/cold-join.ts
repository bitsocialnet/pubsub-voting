 ...
 * Env: `BENCH_RPC_LATENCY_MS` (default 270). The router latency lives with the router (run.mjs).
 */
...
async function main(): Promise<void> {
    ...
    const r = await measureColdJoin({ routerUrl, seederPeerId, topic, expectedN, rpcLatencyMs });
